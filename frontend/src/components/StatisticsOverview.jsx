      ...
      <div className="glass-effect rounded-2xl p-5">
        <div className="flex items-center gap-4 mb-3">
          ...
          <div>
            ...
            <p className="text-xl font-bold gradient-text-primary">{statistics.totalSolved}</p>
          </div>
        </div>
      ...
      <div className="glass-effect rounded-2xl p-5">
        <div className="flex items-center gap-4 mb-3">
          ...
          <div>
            ...
            <p className="text-xl font-bold gradient-text-primary">{statistics.acceptanceRate}%</p>
          </div>
        </div>
      ...
      <div className="glass-effect rounded-2xl p-5">
        <div className="flex items-center gap-4 mb-3">
          ...
          <div>
            ...
            <p className="text-xl font-bold gradient-text-primary">{progress.totalProblems}</p>
          </div>
        </div>
