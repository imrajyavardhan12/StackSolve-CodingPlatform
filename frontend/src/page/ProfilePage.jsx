...
const ProfilePage = () => {
    ...
    return (
      <div className="min-h-screen gradient-bg flex items-center justify-center">
        <div className="glass-effect rounded-2xl p-8 text-center">
          ...
          <span className="text-white text-base font-medium">Loading your dashboard...</span>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-dark-navy via-dark-surface to-dark-navy">
      {/* Hero Section */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 pt-8 pb-10">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-6">
            <div className="flex items-center gap-5">
              <div className="w-16 h-16 bg-gradient-to-r from-primary to-secondary rounded-2xl flex items-center justify-center shadow-2xl">
                <User className="w-8 h-8 text-dark-navy" />
              </div>
              <div>
                <h1 className="text-3xl lg:text-4xl font-black gradient-text mb-1">
            ...
            <div className="glass-effect rounded-2xl p-5">
              <div className="flex items-center gap-4 mb-3">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-white">{dashboardData.statistics?.totalSolved || 0}</p>
                </div>
              </div>
            ...
            <div className="glass-effect rounded-2xl p-5">
              <div className="flex items-center gap-4 mb-3">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-white">{dashboardData.streak?.currentStreak || 0} days</p>
                </div>
              </div>
            ...
            <div className="glass-effect rounded-2xl p-5">
              <div className="flex items-center gap-4 mb-3">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-white">{dashboardData.statistics?.acceptanceRate || 0}%</p>
                </div>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-6 pb-12">
        ...
        <div className="mb-8">
          <h2 className="text-xl font-bold gradient-text mb-5">Detailed Statistics</h2>
          <StatisticsOverview 
          ...
          {isCalendarLoading ? (
            <div className="glass-effect rounded-2xl p-8">
              <div className="flex items-center justify-center py-8">
                ...
                <span className="text-white font-medium text-sm">Loading calendar data...</span>
              </div>
            </div>
          ) : (
            <CalendarHeatmap
                ...
                <table className="table table-sm w-full">
                  <thead className="bg-gradient-to-r from-primary/10 to-secondary/10">
                    <tr className="border-b border-primary/20">
                      <th className="text-white font-semibold text-sm">Date</th>
                      <th className="text-white font-semibold text-sm">Problems Solved</th>
                      <th className="text-white font-semibold text-sm">Submissions</th>
                    </tr>
                  </thead>
                  <tbody>
                    {dashboardData.recentActivity.map((activity, index) => (
                      <tr key={index} className="border-b border-primary/10 hover:bg-primary/5 transition-colors">
                        ...
                        <td>
                          <span className="badge badge-success font-medium text-xs">
                            {activity.problemsSolved}
                          </span>
                        </td>
                        <td>
                          <span className="badge badge-info font-medium text-xs">
