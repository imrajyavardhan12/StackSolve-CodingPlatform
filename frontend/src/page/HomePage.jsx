        ...
        <div className="hero-content text-center z-10 max-w-6xl mx-auto px-4">
          <div className="max-w-4xl">
            ...
            <div className="mockup-code glass-effect max-w-4xl mx-auto text-left animate-glow">
              ...
              <pre className="px-6 py-4"><code className="text-sm md:text-base leading-relaxed">
<span className="code-primary">function</span> <span className="code-secondary">twoSum</span><span className="text-white">(nums, target) {</span>
    <span className="code-primary">const</span> map = <span className="code-primary">new</span> <span className="code-secondary">Map</span>();
    
    <span className="code-primary">for</span> (<span className="code-primary">let</span> i = <span className="code-success">0</span>; i < nums.length; i++) {
        <span className="code-primary">const</span> complement = target - nums[i];
        
        <span className="code-primary">if</span> (map.<span className="code-secondary">has</span>(complement)) {
            <span className="code-primary">return</span> [map.<span className="code-secondary">get</span>(complement), i];
        }
        
        map.<span className="code-secondary">set</span>(nums[i], i);
    }
    
    <span className="code-primary">return</span> [];
}

<span className="code-comment">// Time: O(n) | Space: O(n)</span>
              </code></pre>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Same problem logic - enhanced presentation */}
          {
            problems.length > 0 ? (
